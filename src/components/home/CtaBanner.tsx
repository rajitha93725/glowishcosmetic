        ...
        <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden bg-gradient-to-r from-[#333333] via-[#444444] to-[#333333] px-6 sm:px-8 py-12 sm:py-20 text-center">
          ...
          <div className="relative z-10">
            ...
            <div className="flex gap-3 sm:gap-4 justify-center flex-wrap">
              ...
              <Link
                href="/contact"
                className="border-2 border-white/60 text-white font-semibold px-6 sm:px-8 py-3 sm:py-4 rounded-full text-sm tracking-wide hover:bg-white/10 transition-colors"
              >
                Ask a Question
              </Link>
            </div>
